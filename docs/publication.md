...
| `witness_register` | companion beside the set — co-registration without aggregation | <https://github.com/docxology/witness_register> | not yet minted |
